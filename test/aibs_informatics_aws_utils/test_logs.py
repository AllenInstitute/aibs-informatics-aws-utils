...
class LogsTests(AwsBaseTest):
    ...
    def test__build_log_stream_url__works(self):
        ...
        expected = "https://us-west-2.console.aws.amazon.com/cloudwatch/home?region=us-west-2#logsV2:log-groups/log-group/$252Faws$252Fbatch$252Fjob/log-events/weird-_$2529$2528name"
