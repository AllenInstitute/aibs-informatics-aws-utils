# Contributing to `aibs-informatics-aws-utils`
...
Report bugs to our [issues page](https://github.com/aibs-informatics-aws-utils/issues).
...
The best way to send feedback is to [create an issue](https://github.com/aibs-informatics-aws-utils/issues/new) on GitHub.
